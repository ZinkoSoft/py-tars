...
TTS_RESPONSE_WINDOW_SEC = float(os.getenv("TTS_RESPONSE_WINDOW_SEC", "10.0"))
...
NOISE_MIN_DURATION_MS = int(os.getenv("NOISE_MIN_DURATION_MS", "500"))
NOISE_MIN_RMS = int(os.getenv("NOISE_MIN_RMS", "220"))
...
NOISE_GATE_OFFSET = float(os.getenv("NOISE_GATE_OFFSET", "2.0"))
NOISE_MIN_ALPHA_RATIO = float(os.getenv("NOISE_MIN_ALPHA_RATIO", "0.6"))
...
# Enable enhanced numpy-based speech analysis in VAD
VAD_ENHANCED_ANALYSIS = int(os.getenv("VAD_ENHANCED_ANALYSIS", "1"))

# Noise floor calibration settings
NOISE_FLOOR_CALIB_SECS = float(os.getenv("NOISE_FLOOR_CALIB_SECS", "2.0"))
NOISE_FLOOR_CALIB_ENABLE = int(os.getenv("NOISE_FLOOR_CALIB_ENABLE", "1"))
NOISE_FLOOR_ADAPTIVE_ENABLE = int(os.getenv("NOISE_FLOOR_ADAPTIVE_ENABLE", "1"))
NOISE_FLOOR_THRESHOLD_MULTIPLIER = float(os.getenv("NOISE_FLOOR_THRESHOLD_MULTIPLIER", "3.0"))
NOISE_FLOOR_UPDATE_INTERVAL = int(os.getenv("NOISE_FLOOR_UPDATE_INTERVAL", "50"))
