...
from ..discovery.base import MCPServerMetadata, TransportType
...
class ConfigGenerator:
    ...
    def generate(
        ...
        installation_summary: Optional[InstallationSummary] = None,
    ) -> GeneratedConfig:
    ...
    def _build_discovery_summary(
        self, servers: list[MCPServerMetadata]
    ) -> dict[str, Any]:
    ...
    def _build_installation_summary(
        self, installation_summary: Optional[InstallationSummary]
    ) -> dict[str, Any]:
