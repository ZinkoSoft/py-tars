...
class ConfigWriter:
    ...
    def write(self, config: GeneratedConfig) -> str:
        ...
        try:
            ...
            raise ValueError(f"Failed to serialize config to JSON: {e}")
        ...
        try:
            ...
            if temp_path and os.path.exists(temp_path):
                try:
                    ...
                    pass
            raise OSError(f"Failed to write config file: {e}")

    def read(self, validate: bool = True) -> Optional[GeneratedConfig]:
        ...
        try:
            ...
            raise OSError(f"Failed to read config file: {e}")

    def _validate_structure(self, config_dict: dict) -> None:
