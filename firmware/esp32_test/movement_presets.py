...
PRESETS = {
    ...
    "step_forward": {
        ...
        "steps": [
            ...
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.5},
        ]
    },
    ...
    "right_hi": {
        ...
        "steps": [
            ...
            {"targets": make_arm_targets(100, 100, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            # Wave 3 times
            {"targets": make_arm_targets(100, 50, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 50, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 50, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 1, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
    ...
    "laugh": {
        ...
        "steps": [
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(1, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(1, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(1, 50, 50), "speed": 0.0, "delay_after": 0.1},
            ...
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(1, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.2},
        ]
    },
    ...
    "swing_legs": {
        ...
        "steps": [
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.0, "delay_after": 0.1},
            {"targets": make_leg_targets(100, 50, 50), "speed": 0.0, "delay_after": 0.1},
    ...
    "mic_drop": {
        ...
        "steps": [
            ...
            {"targets": make_arm_targets(1, 1, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(60, 50, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(60, 70, 1, 0, 0, 0), "speed": 0.0, "delay_after": 1.0},
            {"targets": make_arm_targets(60, 70, 100, 0, 0, 0), "speed": 0.0, "delay_after": 2.0},
            {"targets": make_arm_targets(1, 1, 1, 0, 0, 0), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_leg_targets(80, 50, 50), "speed": 0.2, "delay_after": 0.2},
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.2, "delay_after": 0.5},
        ]
    ...
    "monster": {
        ...
        "steps": [
            ...
            {"targets": make_arm_targets(100, 100, 1, 100, 100, 1), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 100, 100, 100, 100), "speed": 0.0, "delay_after": 0.2},
            # Claw motions
            {"targets": make_arm_targets(100, 50, 100, 100, 100, 100), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 50, 100, 50, 50), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 50, 100, 100, 100, 100), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 50, 100, 50, 50), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 100, 100, 100, 100), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 1, 100, 100, 1), "speed": 0.0, "delay_after": 0.2},
            ...
            {"targets": make_arm_targets(100, 100, 100, 100, 100, 100), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 100, 1, 100, 100, 1), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_arm_targets(100, 1, 1, 100, 1, 1), "speed": 0.0, "delay_after": 0.2},
            {"targets": make_leg_targets(50, 70, 70), "speed": 0.6, "delay_after": 0.2},
            {"targets": make_arm_targets(1, 1, 1, 1, 1, 1), "speed": 0.2, "delay_after": 0.2},
            {"targets": make_leg_targets(80, 50, 50), "speed": 0.6, "delay_after": 0.2},
            {"targets": make_leg_targets(50, 50, 50), "speed": 0.6, "delay_after": 0.2},
